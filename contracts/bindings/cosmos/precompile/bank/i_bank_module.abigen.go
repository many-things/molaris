...
//
// Solidity: function allowance(address owner, address spender, string denom) view returns(uint256)
func (_BankModule *BankModuleCaller) Allowance(opts *bind.CallOpts, owner common.Address, spender common.Address, denom string) (*big.Int, error) {
	var out []interface{}
	err := _BankModule.contract.Call(opts, &out, "allowance", owner, spender, denom)
...
//
// Solidity: function allowance(address owner, address spender, string denom) view returns(uint256)
func (_BankModule *BankModuleSession) Allowance(owner common.Address, spender common.Address, denom string) (*big.Int, error) {
	return _BankModule.Contract.Allowance(&_BankModule.CallOpts, owner, spender, denom)
}

// Allowance is a free data retrieval call binding the contract method 0xfc08930c.
//
// Solidity: function allowance(address owner, address spender, string denom) view returns(uint256)
func (_BankModule *BankModuleCallerSession) Allowance(owner common.Address, spender common.Address, denom string) (*big.Int, error) {
	return _BankModule.Contract.Allowance(&_BankModule.CallOpts, owner, spender, denom)
}
