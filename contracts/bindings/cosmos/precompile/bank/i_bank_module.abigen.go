...
// Allowance is a paid mutator transaction binding the contract method 0x819b666e.
//
// Solidity: function allowance(address spender, string denom) payable returns(uint256)
func (_BankModule *BankModuleTransactor) Allowance(opts *bind.TransactOpts, spender common.Address, denom string) (*types.Transaction, error) {
	return _BankModule.contract.Transact(opts, "allowance", spender, denom)
}

// Allowance is a paid mutator transaction binding the contract method 0x819b666e.
//
// Solidity: function allowance(address spender, string denom) payable returns(uint256)
func (_BankModule *BankModuleSession) Allowance(spender common.Address, denom string) (*types.Transaction, error) {
	return _BankModule.Contract.Allowance(&_BankModule.TransactOpts, spender, denom)
}

// Allowance is a paid mutator transaction binding the contract method 0x819b666e.
//
// Solidity: function allowance(address spender, string denom) payable returns(uint256)
func (_BankModule *BankModuleTransactorSession) Allowance(spender common.Address, denom string) (*types.Transaction, error) {
	return _BankModule.Contract.Allowance(&_BankModule.TransactOpts, spender, denom)
}

// Approve is a paid mutator transaction binding the contract method 0x6168e872.
//
// Solidity: function approve(address spender, (uint256,string)[] amount) payable returns(bool)
func (_BankModule *BankModuleTransactor) Approve(opts *bind.TransactOpts, spender common.Address, amount []CosmosCoin) (*types.Transaction, error) {
	return _BankModule.contract.Transact(opts, "approve", spender, amount)
}

// Approve is a paid mutator transaction binding the contract method 0x6168e872.
//
// Solidity: function approve(address spender, (uint256,string)[] amount) payable returns(bool)
func (_BankModule *BankModuleSession) Approve(spender common.Address, amount []CosmosCoin) (*types.Transaction, error) {
	return _BankModule.Contract.Approve(&_BankModule.TransactOpts, spender, amount)
}

// Approve is a paid mutator transaction binding the contract method 0x6168e872.
//
// Solidity: function approve(address spender, (uint256,string)[] amount) payable returns(bool)
func (_BankModule *BankModuleTransactorSession) Approve(spender common.Address, amount []CosmosCoin) (*types.Transaction, error) {
	return _BankModule.Contract.Approve(&_BankModule.TransactOpts, spender, amount)
}
